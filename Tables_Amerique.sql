...
GRANT SELECT ON CATEGORIES TO fkilic;
GRANT SELECT ON CLIENTS_AMERIQUE TO fkilic;
GRANT SELECT ON CLIENTS_EUROPE_DU_SUD TO fkilic;
GRANT SELECT ON COMMANDES_AMERIQUE TO fkilic;
GRANT SELECT ON COMMANDES_EUROPE_DU_SUD TO fkilic;
GRANT SELECT ON DETAILS_COMMANDES_AMERIQUE TO fkilic;
GRANT SELECT ON DETAILS_COMMANDES_EUROPE_DU_SUD TO fkilic;
GRANT SELECT ON EMPLOYES TO fkilic;
GRANT SELECT ON PRODUITS TO fkilic;
GRANT SELECT ON STOCK_AMERIQUE TO fkilic;
GRANT SELECT ON STOCK_EUROPE_DU_SUD TO fkilic;